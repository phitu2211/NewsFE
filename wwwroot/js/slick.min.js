				...
				null !== d
					? null !== b.activeBreakpoint
						? d !== b.activeBreakpoint &&
						  ...
						  (b.options = a.extend({}, b.originalSettings, b.breakpointSettings[d])),
						  b.refresh())
						: ((b.activeBreakpoint = d),
						  (b.options = a.extend({}, b.originalSettings, b.breakpointSettings[d])),
						  b.refresh())
					: null !== b.activeBreakpoint &&
					  ((b.activeBreakpoint = null), (b.options = b.originalSettings), b.refresh());
			}
		}),
			...
			switch (
				...
				case "index":
					var k =
						0 === b.data.index
							? 0
							: b.data.index || a(b.target).parent().index() * d.options.slidesToScroll;
				...
				b.options.infinite === !0
					? (b.slideCount > b.options.slidesToShow &&
					  ...
					  0 !== b.slideCount % b.options.slidesToScroll &&
							...
							(a > b.slideCount
								? ((b.slideOffset =
										-1 * (b.options.slidesToShow - (a - b.slideCount)) * b.slideWidth),
								  (e = -1 * (b.options.slidesToShow - (a - b.slideCount)) * d))
								: ((b.slideOffset =
										((-1 * b.slideCount) % b.options.slidesToScroll) * b.slideWidth),
		...
		(b.prototype.setDimensions = function () {
			...
			if (
				...
				(b.slideWidth = Math.ceil(b.listWidth / b.options.slidesToShow)),
					b.$slideTrack.width(
						Math.ceil(b.slideWidth * b.$slideTrack.children(".slick-slide").length)
					);
				...
				(b.slideWidth = Math.ceil(b.listWidth)),
					b.$slideTrack.height(
						Math.ceil(
							b.$slides.first().outerHeight(!0) * b.$slideTrack.children(".slick-slide").length
						)
					);
							...
							? (void 0 !== a.originalEvent && b.touchObject.swipeLength > 4 && a.preventDefault(),
							  ...
							  (b.swipeLeft =
									b.options.vertical === !1
										...
										: c + b.touchObject.swipeLength * (b.$list.height() / b.listWidth) * e),
